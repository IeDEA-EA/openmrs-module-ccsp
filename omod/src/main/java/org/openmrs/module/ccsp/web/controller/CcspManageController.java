 ...
 */
package org.openmrs.module.ccsp.web.controller;
 ...
 */
@Controller
public class  CcspManageController {
    ...
    public void importdata(ModelMap model) {
        System.out.println("This is from the Test Import Code");
        AmpathLogbookUtils ampathlogs = new AmpathLogbookUtils();
